 ...
 */
final class Version20240513080642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_library DROP favorite');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_library ADD favorite TINYINT(1) NOT NULL');
    }
}
